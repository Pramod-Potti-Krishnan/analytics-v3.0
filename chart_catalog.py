...
D3JS_TYPES = [
    ChartType(
        id="d3_treemap",
        name="D3 Treemap",
        description="Hierarchical treemap visualization using D3.js v7 with SVG rendering",
        library=ChartLibrary.D3JS,
        supported_layouts=[SupportedLayout.L02],
        min_data_points=2,
        max_data_points=50,
        optimal_data_points="4-15 rectangles",
        use_cases=[
            "Budget allocation by department",
            "Market share distribution",
        ...
        visual_properties={
            ...
            "colors": "Vibrant 8-color palette",
            "hover": "Opacity changes on mouseover"
        },
        interactive_features=["Hover effects", "Reveal.js slide integration"]
    ),

    ChartType(
        id="d3_sunburst",
        name="D3 Sunburst",
        description="Radial hierarchical visualization using D3.js partition layout",
        library=ChartLibrary.D3JS,
        supported_layouts=[SupportedLayout.L02],
        min_data_points=2,
        max_data_points=50,
        optimal_data_points="4-12 segments",
        use_cases=[
        ...
        visual_properties={
            "rendering": "SVG-based radial partition layout",
            "animations": "None (immediate render)",
            "colors": "Vibrant 8-color palette",
            "hover": "Opacity changes on mouseover",
            "layout": "Concentric circles for hierarchy levels"
        },
        interactive_features=["Hover effects", "Reveal.js slide integration"]
    ),
    ...
    ChartType(
        ...
        name="D3 Choropleth USA Map",
        description="Geographic choropleth map of USA states using D3.js and TopoJSON",
        library=ChartLibrary.D3JS,
        supported_layouts=[SupportedLayout.L02],
        min_data_points=1,
        max_data_points=50,
        optimal_data_points="5-20 states",
        use_cases=[
        ...
        visual_properties={
            "rendering": "SVG-based geographic projection",
            "projection": "d3.geoAlbersUsa() for USA",
            "animations": "None (immediate render)",
            "colors": "Quantize color scale (5 bins)",
            "hover": "Interactive tooltips with state data",
            "legend": "Vertical gradient legend"
        },
        interactive_features=["Hover tooltips", "Color-coded value ranges", "Reveal.js slide integration"]
    ),

    ChartType(
        id="d3_sankey",
        name="D3 Sankey Diagram",
        description="Flow diagram showing movement between nodes using D3.js and d3-sankey plugin",
        library=ChartLibrary.D3JS,
        supported_layouts=[SupportedLayout.L02],
        min_data_points=2,
        max_data_points=50,
        optimal_data_points="5-15 flows",
        use_cases=[
        ...
        examples=[
            "Budget allocation: Revenue → Departments → Projects",
            "Website traffic: Source → Landing Page → Conversion",
            "Energy flow: Production → Distribution → Consumption"
        ],
        data_requirements={
            "fields": ["label", "value"] or ["source", "target", "value"],
            "label_format": "'Source → Target' or explicit source/target fields",
            "value_format": "Numeric flow values"
        },
        visual_properties={
            "rendering": "SVG-based flow diagram",
            "animations": "None (immediate render)",
            "colors": "Color-coded nodes and flows",
            "hover": "Interactive tooltips with flow details",
            "layout": "Left-to-right horizontal flow"
        },
        interactive_features=["Hover tooltips on nodes and links", "Flow highlighting", "Reveal.js slide integration"]
    )
]
...
ALL_CHART_TYPES = CHARTJS_TYPES + D3JS_TYPES
...
def get_chartjs_types() -> List[ChartType]:
    """Get Chart.js chart types."""
    return CHARTJS_TYPES


def get_d3js_types() -> List[ChartType]:
    """Get D3.js chart types."""
    return D3JS_TYPES
...
def get_chart_type_summary() -> Dict[str, Any]:
    ...
    return {
        ...
        "d3js_types": len(D3JS_TYPES),
        "l02_compatible": len(get_chart_types_by_layout(SupportedLayout.L02)),
        "chart_libraries": [ChartLibrary.CHARTJS.value, ChartLibrary.D3JS.value],
