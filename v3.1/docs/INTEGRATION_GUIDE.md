...
**Example** (for d3_sunburst):
```
Create a presentation slide showing our FY 2025 budget hierarchy across all departments. Use a d3_sunburst chart type to visualize the following data:
- Engineering: $800,000
- Sales: $600,000
- Marketing: $400,000
- Operations: $350,000
...
The slide should use a radial sunburst diagram to show the hierarchical budget structure and highlight which departments consume the largest portions of our budget.
```

**Example** (for d3_choropleth_usa):
```
Create a presentation slide showing our Q4 2024 regional sales performance across the United States. Use a d3_choropleth_usa chart type to visualize the following state-level data:
- California: $850,000
- Texas: $720,000
- New York: $690,000
- Florida: $580,000
...
The slide should use a color-coded USA map to show geographic distribution of sales performance, highlighting which states are our strongest markets and identifying potential growth opportunities in underperforming regions.
```
